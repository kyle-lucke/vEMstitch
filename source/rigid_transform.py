...
def rigid_transform(kp1, dsp1, kp2, dsp2, im1_mask, im2_mask, mode, **kwargs):
    dis = 0.0
    if mode == "d":
    ...
    X1, X2 = flann_match(kp1, dsp1, kp2, dsp2, ratio=0.4, im1_mask=im1_mask, im2_mask=im2_mask, shifting=shifting, **kwargs)
    if len(X1) == 0:
